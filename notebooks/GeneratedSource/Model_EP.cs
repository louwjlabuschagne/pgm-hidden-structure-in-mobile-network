...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 12:53 on Tuesday, 11 October 2022.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public bool[] isDetractor
		{
			...
			set {
				if ((value!=null)&&(value.Length!=500)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+500)+" was expected for variable \'isDetractor\'");
				}
		...
		public int[] numSitesForCustomers
		{
			...
			set {
				if ((value!=null)&&(value.Length!=500)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+500)+" was expected for variable \'numSitesForCustomers\'");
				}
		...
		public int[][] sitesTouched
		{
			...
			set {
				if ((value!=null)&&(value.Length!=500)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+500)+" was expected for variable \'sitesTouched\'");
				}
		...
		private void Changed_isDetractor()
		{
			...
			this.isDetractor_marginal_F = new DistributionStructArray<Bernoulli,bool>(500);
		...
		private void Changed_isDetractor_kpis_numberOfIterations_numSitesForCustomers_sitesLabel_sitesTouched_vbool__5_vb0(int numberOfIterations)
		{
			...
			Bernoulli[] hadBadSiteInt_index1__selector_cases_1_B = new Bernoulli[500];
			for(int index1 = 0; index1<500; index1++) {
			...
			DistributionStructArray<Bernoulli,bool>[] hadBadSiteInt_index1__selector_cases_B = new DistributionStructArray<Bernoulli,bool>[500];
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[] hadBadSiteInt_index1__selector_cases_0_B = new Bernoulli[500];
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[][] hadBadSiteInt_index1__selector_uses_B = new Bernoulli[500][];
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[] hadBadSiteInt_index1__selector_uses_B_toDef = new Bernoulli[500];
			DistributionStructArray<Bernoulli,bool> hadBadSiteInt_F;
			// Create array for 'hadBadSiteInt' Forwards messages.
			hadBadSiteInt_F = new DistributionStructArray<Bernoulli,bool>(500);
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[] anyTrue_B = new Bernoulli[500];
			for(int index1 = 0; index1<500; index1++) {
				anyTrue_B[index1] = Bernoulli.Uniform();
			}
			// Create array for replicates of 'vbool__8_B'
			DistributionStructArray<Bernoulli,bool>[] vbool__8_B = new DistributionStructArray<Bernoulli,bool>[500];
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[] anyTrue_F = new Bernoulli[500];
			for(int index1 = 0; index1<500; index1++) {
				anyTrue_F[index1] = Bernoulli.Uniform();
			}
			// Create array for replicates of 'hadBadSiteInt_index1__selector_uses_F_marginal'
			Bernoulli[] hadBadSiteInt_index1__selector_uses_F_marginal = new Bernoulli[500];
			for(int index1 = 0; index1<500; index1++) {
			...
			Bernoulli[][] hadBadSiteInt_index1__selector_uses_F = new Bernoulli[500][];
			for(int index1 = 0; index1<500; index1++) {
			...
			Beta[] trueDetractor__0__B = new Beta[500];
			// Create array for replicates of 'trueDetractor__B'
			Beta[][] trueDetractor__B = new Beta[500][];
			for(int index1 = 0; index1<500; index1++) {
			...
			Beta[] falseDetractor__1__B = new Beta[500];
			// Create array for replicates of 'falseDetractor__B'
			Beta[][] falseDetractor__B = new Beta[500][];
			for(int index1 = 0; index1<500; index1++) {
			...
			this.hadBadSiteInt_marginal_F = new DistributionStructArray<Bernoulli,bool>(500);
			for(int index1 = 0; index1<500; index1++) {
		...
		private void Constant()
		{
			...
			this.precisions_F_reduced = WishartFromShapeAndScaleOp.SampleAverageConditional(0.10000000000000001, this.vPositiveDefiniteMatrix3);
			...
			PositiveDefiniteMatrix vPositiveDefiniteMatrix0 = new PositiveDefiniteMatrix(new double[2, 2] {{0.10000000000000001, 0.0}, {0.0, 0.10000000000000001}});
			...
			this.relevantSites_B = new DistributionStructArray<Bernoulli,bool>[500];
			...
			// Create array for 'sites_sitesTouched' Forwards messages.
			this.sites_sitesTouched_F = new DistributionRefArray<DistributionStructArray<Bernoulli,bool>,bool[]>(500);
			this.vBeta1 = new Beta(2.0, 5.0);
			// Create array for 'falseDetractor_rep' Backwards messages.
			this.falseDetractor_rep_B = new Beta[500];
			this.vBeta0 = new Beta(5.0, 2.0);
			// Create array for 'trueDetractor_rep' Backwards messages.
			this.trueDetractor_rep_B = new Beta[500];
			// Create array for replicates of 'vbool__8_F'
			this.vbool__8_F = new DistributionStructArray<Bernoulli,bool>[500];
			this.vbool9 = true;
